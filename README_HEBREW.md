...
## 🎯 מקור אוטומטי למילוי נוכחות (HRM Portal)

![ממשק המערכת](docs/ui.png)
...
4. **דוח והתקדמות בזמן אמת** 📊
   - צפייה במסך התקדמות (כמה נוצרו/דולגו/נכשלו)
   - יומן פעולות שקוף (לוגים מהמערכת)
   - אפשרות להוריד דוח CSV בסוף התהליך

   ![מסך התקדמות](docs/progress.png)
